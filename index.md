...
<html>
    <head>
        <meta charset="utf-8">
        <title>Nueva pagina web (todo sobre hamsters)</title>
        <style>
            h1 {
                color: rgb(21, 1, 53);
                text-align: center;
            ...
            #indice {
                background-color: rgba(136, 87, 87, 0.432);
                width: 13em;
            }
            #hamster-diet {
                color:rgb(66, 10, 10);
            ...
            .tables {
                background-color: rgba(228, 206, 180, 0.685);
            }
            .table-head {
    ...
    <body>
        ...
        <ul>
            ...
            <li class="name-hamster">Cricetulus</li>
            <ul class="list-hamster">
                <br>
